...
$(document).ready(function () {
    ...
    // $.get("templates/datavisualization/dashboard/js/xicheng.json", function (geoJson) {
    ...
    radarChart1.setOption(option_radarChart);
    radarChart2.setOption(option_radarChart);
    radarChart3.setOption(option_radarChart);
});
